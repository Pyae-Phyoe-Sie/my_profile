...
export default function PERSONAL_INFORMATION() {
    const [myData, setMyData] = useState<MYDATA>(getMyData())
                ...
                <div className="col-span-4 md:col-span-9">
                    <div className="bg-white shadow xl:rounded-lg p-6">
                        ...
                        <div className="flex justify-center items-center gap-6 my-6">
                            ...
                            {(myData?.personal_information.hackerRank != "") && <a className="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Map"
                                href={myData?.personal_information.hackerRank}
                                target="_blank">
